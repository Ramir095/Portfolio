  ...
  return (
    <div className="h-screen xl:max-w-full flex justify-center items-center flex-col lg:flex-row-reverse xl:pr-[11rem] 2xl:pr-[12rem] lg:space-x-0 xl:space-x-[-15rem] 2xl:space-x-[-10rem] flex-wrap space-y-2 md:space-y-0 lg:space-y-0 overflow-hidden" id="home">
      ...
      <div className="lg:relative lg:rounded-full lg:border-solid lg:border-t-[1px] lg:border-r-[1px] lg:border-gray-700  lg:border-l-2 lg:border-b-[1px] lg:border-l-[#2E3140] lg:right-[0.5rem] lg:top-[8rem] xl:right-[-11rem] xl:top-[9.5rem] 2xl:right-[-12rem] 2xl:top-[5.2rem] lg:w-[23rem] lg:h-[24rem] xl:w-[35rem] xl:h-[35rem]">
        ...
        <div className="relative xl:block xl:absolute top-[-2.5rem] rounded-full w-[16rem] h-[18rem] md:top-[-2rem] md:w-[28rem] md:h-[28rem] border-solid border-t-2 border-r-2 border-gray-600 border-l-2 border-l-[#2E3140] mt-7 right-[-0.8rem] md:right-[1rem] xl:right-[3rem] xl:top-1 xl:h-[31rem] xl:w-[31rem] lg:right-[-1.2rem] lg:top-[0.2rem] lg:h-[20rem] lg:w-[19rem]">
          ...
          <div className="lg:absolute lg:rounded-full lg:border-solid lg:border-t-[1px] lg:border-r-[1px] lg:border-gray-700 lg:border-l-8 lg:border-l-[#2E3140] lg:border-b-[1px] lg:right-[2.5rem] lg:top-9 xl:right-[3rem] xl:top-9 xl:w-[30rem] xl:h-[27rem] lg:w-[19rem] lg:h-[16rem]">
            ...
            <div className="left-[-1.5rem] bottom-[-2rem] md:bottom-[-1.5rem] md:left-[1rem] ml-[-40px] absolute lg:w-[33rem] lg:h-0 xl:w-[33rem] xl:h-0 lg:top-[-10rem] lg:left-[-1rem] xl:left-[-0.5rem] xl:top-[-13.3rem]">
            ...
            <div>
              <a
                ...
                className={`absolute z-30 right-[2.5rem] top-[-0.4rem] md:right-[4.3rem] md:top-[1rem] lg:right-[2rem] lg:top-[-3.3rem] xl:right-[3.1rem] xl:top-[-2.4rem] 2xl:right-[3rem] 2xl:top-[-2.3rem] ${commonClass}`}
              ...
              <a
                className={`absolute right-[-0.8rem] top-11 md:right-[-0.1rem] md:top-[5.6rem] lg:right-[-2.9rem] lg:top-[0.9rem] xl:right-[-3.2rem] xl:top-[3.5rem] 2xl:right-[-3.1rem] 2xl:top-[3.9rem] ${commonClass}`}
              ...
              <a
                className={`absolute right-[-1.6rem] top-[7.4rem] md:right-[-1.7rem] md:top-[12.3rem] lg:right-[-4.1rem] lg:top-[7.5rem] xl:right-[-5.2rem] xl:top-[12.5rem] 2xl:right-[-4.9rem] 2xl:top-[12.9rem] ${commonClass}`}
              ...
              <a
                className={`absolute z-30 right-[-0.6rem] top-[12.1rem] md:right-[0.1rem] md:top-[19.2rem] lg:right-[-1rem] lg:top-[13.5rem] xl:right-[-1.5rem] xl:top-[21.1rem] ${commonClass}`}
